package com.example.springboot.sms.service;

import com.example.springboot.common.config.CacheKeyConfig;
import com.example.springboot.common.util.CommonUtil;
import com.example.springboot.common.util.RedisUtil;
import com.example.springboot.sms.util.SMSUtil;
...
public class SMSService {
    ...
    public Map<String, Object> sendRegisterVerifyCode(String username) {
        ...
        String code = CommonUtil.Born4Code();
        String key = this.getRegisterVerifyCodeCacheKey(username);
